...
sbatch \
    ...
    --wrap="singularity exec --nv -B ${project_dir},${data_root} ${simg_path} /bin/bash /win/scallop/user/aditya/Pix2Pix/PyTorch-Pix2Pix-Modified/scripts/train_vit7mask.sh"  